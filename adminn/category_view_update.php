                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form role="form" action="category_view_update_save.php" name="dataform" method="POST" enctype="multipart/form-data">


                                        <div class="form-group">
                                            <label>Category ID</label>
                                            <input class="form-control" name="category_id" value="<?php echo $result['category_id']; ?>" readonly />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>

                                        <div class="form-group">
                                            <label>Category Name</label>
                                            <input class="form-control" name="category_name" value="<?php echo $result['category_name']; ?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>
