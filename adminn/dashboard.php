            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                   ...
                   <!--   <li>
                    ...
                    <!-- <li>
                        <a href="#"><i class="fa fa-sitemap fa-3x"></i> MENU<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="view_dish_menu.php">DISH MENU</a>
                            </li>
                            <li>
                                <a href="view_deal_menu.php">DEAL MENU</a>
                            </li>
                        </ul>
                      </li> 	 -->
...
<!--                      <li  >
        ...
        <div id="page-wrapper" >
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Admin Dashboard</h2>   
                        <h5>Welcome <?php echo strtoupper($_SESSION["user1"]); ?> , Love to see you back. </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
			...
			<div class="panel panel-back noti-box">
                ...
                $query0 = "SELECT count(1) FROM order1";
                ...
                ?>
                <div class="text-box" >
                    <p class="main-text"><?php echo $total; ?></p>
			...
			<div class="panel panel-back noti-box">
                ...
                <?php 
                $query0 = "SELECT count(1) FROM dish";
                $fetch0 = mysql_query($query0) or die(mysql_error());
                $result0 = mysql_fetch_array($fetch0);
                $total = $result0[0];
			...
			<div class="panel panel-back noti-box">
                ...
                <?php 
                $query0 = "SELECT count(1) FROM deal";
                $fetch0 = mysql_query($query0) or die(mysql_error());
                $result0 = mysql_fetch_array($fetch0);
                $total = $result0[0];
			...
			<div class="panel panel-back noti-box">
                ...
                <?php 
                $query0 = "SELECT count(1) FROM devices";
                $fetch0 = mysql_query($query0) or die(mysql_error());
                $result0 = mysql_fetch_array($fetch0);
                $total = $result0[0];
                ...
                $fetch0 = mysql_query($query0) or die(mysql_error());
                $result1 = mysql_fetch_assoc($fetch0);
                ...
                ?>
                   <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form role="form" action="dish_add_save.php" name="dataform" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>First name</label>
                                            <input readonly class="form-control" name="item_name" value="<?php echo $result1['admin_first_name']?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>
                                        <div class="form-group">
                                            <label>Last name</label>
                                            <input readonly class="form-control" name="item_name" value="<?php echo $result1['admin_last_name']?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>
                                         <div class="form-group">
                                            <label>Email</label>
                                            <input readonly class="form-control" name="item_name" value="<?php echo $result1['admin_email']?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>

                                        <div class="form-group">
                                            <label>Address</label>
                                            <input readonly class="form-control" name="item_name" value="<?php echo $result1['admin_address']?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>

                                        <div class="form-group">
                                            <label>User name</label>
                                            <input readonly class="form-control" name="item_name" value="<?php echo $result1['admin_username']?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>

                                        <div class="form-group">
                                            <label>Password</label>
                                            <input readonly class="form-control" name="item_name" value="<?php echo $result1['admin_password']?>" />
                                            <input type="button" class="btn btn-default" value="Change password" onClick="window.location.href='admin_pass_update.php?id=<?php echo $result1['admin_id'] ?>';">
