            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                   ...
                   <!--   <li>
                     ...
                     --><li>
                        <a href="#" class="active-menu"><i class="fa fa-desktop fa-3x"></i> Category<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="category_add.php">Add a new Category</a>
                            </li>
                            <li>
                                <a class="active-menu" href="category_view.php">View Category</a>
                            </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>CATEGORY</h2> 
                        <h5>Welcome <?php echo $_SESSION["user1"]; ?>  , to devices section </h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            <td><?php echo $records['category_id'] ;?></td>
                                            <td style="white-space:pre" class="center"><?php echo $records['category_name'] ;?></td>
                                            <td class="center"><input type="button" value="EDIT" onClick="window.location.href='category_view_update.php?category_id=<?php echo $records['category_id'] ?>';"></td>
                                            <td class="center"><input type="button" value="DELETE" onClick="window.location.href='category_view_delete.php?category_id=<?php echo $records['category_id'] ?>& category_name=<?php echo $records['category_name'] ?>';"></td>
                                        </tr>
