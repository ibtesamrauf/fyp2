                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form role="form" action="dish_view_update_save.php" name="dataform" method="POST" enctype="multipart/form-data">


                                        <div class="form-group">
                                            <label>Item ID</label>
                                            <input class="form-control" name="dish_id" value="<?php echo $result['dish_id']; ?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>

                                        <div class="form-group">
                                            <label>Item Name</label>
                                            <input class="form-control" name="dish_name" value="<?php echo $result['dish_name']; ?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>

                                        <div class="form-group">
                                            <label>Descrpition</label>
                                            <textarea class="form-control" rows="3"  name="dish_desc"><?php echo $result['dish_desc']; ?></textarea>
                                        </div>
