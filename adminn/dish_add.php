  ...
  <span id="clockbox" style="padding-right:15px" ></span>
    <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> 
                   ...
                   <!--   <li>
                    ...
                    <li>
                      ...
                      <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a  class="active-menu" href="dish_add.php">Add a new DISH</a>
                            </li>
                            <li>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form role="form" action="dish_add_save.php" name="dataform" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="item_desc"></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Dish estimated time</label>
                                            <input type="number" min='1' class="form-control" placeholder="PLease Enter Keyword" name="dish_est_time" />
                                        </div>
      ...
      <!--                                   <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="PLease Enter Keyword" name="item_catagory" />
                                        </div>
 -->

                                        <div class="form-group">
                                            <label>Dish price</label>
                                            <input type="number" min='1' class="form-control" placeholder="PLease Enter Keyword" name="item_price" />
                                        </div>
