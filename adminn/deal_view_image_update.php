                    ...
                    <li>
                      ...
                      <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a c href="dish_view.php">View DISH</a>
                            </li>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form role="form" action="deal_view_image_update_save.php" name="dataform" method="POST" enctype="multipart/form-data">


                                        <div class="form-group">
                                            <label>Item ID</label>
                                            <input class="form-control" readonly="true" name="dish_id" value="<?php echo $result['deal_id']; ?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>

                                        <div class="form-group">
                                            <label>Item Name</label>
                                            <input class="form-control" readonly="true" name="dish_name" value="<?php echo $result['deal_name']; ?>" />
                                            <!-- <p class="help-block">Help text here.</p> -->
                                        </div>

                                            <input type="hidden" name="dish_url" value="<?php echo $result['deal_image_url']; ?>" />
