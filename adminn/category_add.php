                   ...
                   <!--   <li>
                     ...
                     --><li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a  class="active-menu" href="category_add.php">Add a new Category</a>
                            </li>
                            <li>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form role="form" action="category_add_save.php" name="dataform" method="POST" enctype="multipart/form-data">
