                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>Decice ID</th>
                                            <th>Decice Mac and Ip Address</th>
                                            <th>Decice Table Number</th>
                                            <th>EDIT</th>
                                            <!-- <th>DELETE</th> -->
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            <td><?php echo $records['device_id'] ;?></td>
                                            <td style="white-space:pre" class="center"><?php echo $records['mac_address'] ;?></td>
                                            <td class="center"><?php echo $records['table_number'] ;?></td>
                                            <td class="center"><input type="button" value="EDIT" onClick="window.location.href='devices_view_update.php?id=<?php echo $records['device_id'] ?>';"></td>
                                            <!-- <td class="center"><input type="button" value="DELETE" onClick="window.location.href='devices_view_delete.php?id=<?php echo $records['device_id'] ?>';"></td> -->
                                        </tr>
