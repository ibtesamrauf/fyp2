...
$query = "SELECT * FROM dish where dish_id = ".$id_nn;
...
<div >  
<a href="#" ><img src="<?php echo $result['dish_image_url'] ?>" alt=" " style="width:270px;height:300px;"/></a>
</div>   
...
// echo "<button onclick='ppp()'> click me</button>";

?>
<script>
// function vxr (argument) 
// {
// 	var pp = "nnn";
// 	var <?php $ca ?> = pp;
// 	}
...
<?php 
// echo "<script>
// function ppp1 (argument) 
// {
// 		alert('$ca');
// 	}
// </script>";
// echo "<br><br><button onclick='vxr()'> assign</button> <br>";
// echo "<button onclick='ppp1()'> show</button>";
?>

				<div class="desc span_3_of_2">
					<h2  style="font-size:20pt"><?php echo $result['dish_name']; ?> </h2>
					<div class="price">
						<p>Price: <span><?php echo $result['dish_price'] ?> </span></p>

					</div>
<form action="add_to_cart_test.php?id=<?php echo $result['dish_id'];?>" method="POST">
					...
					<div>
						<table width="100%">
							<tr>
								...
								<td><?php echo $result['dish_desc'] ?></td>
							</tr>
