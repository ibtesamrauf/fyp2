...
include("con_db.php");
			...
			if ($result1['order_status'] == 4) 
			{
				echo "<script> alert('Order has been cenceled by Admin, Please Contact Admin');
				window.location.href='index.php';
				</script>";
			}
			else
			{
					$query = "UPDATE order1 SET order_status=2 where order_id =".$order_id;
