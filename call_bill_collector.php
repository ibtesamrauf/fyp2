  ...
  <div class="header_bottom">
        <div class="menu">
          <ul>
            ...
            <li class="active"><a href="call_bill_collector_save.php">CALL BILL COLLECTOR</a></li>
            <?php
...
$cart_item=array('time1'=> $time1);

// array_key_exists($id, $_SESSION['call_waiter_a']);

$_SESSION['call_waiter_a'][$table_num]=$cart_item;
...
$flag = $_GET['flag'];
 if ($flag) 
 {
    ...
    echo "<div class='alert alert-success'>";
        echo "<strong>Waiter is coming to your table.</strong> Press OK to go to main manu";
        // echo "<br><br>&nbsp&nbsp <input type='button' value='OK'>";
    echo "</div>";
        echo "<a href='index.php' class='btn btn-lg btn-success m-b-10px'>";
                echo "<span class='glyphicon glyphicon-shopping-cart'></span> OK";
            echo "</a>";
 ...
 else
 {
    ...
    echo "<div class='alert alert-danger'>";
        echo "<strong>Having some problem press call bill collector button again</strong>";
    echo "</div>";
     echo "<a href='index.php' class='btn btn-lg btn-success m-b-10px'>";
                echo "<span class='glyphicon glyphicon-shopping-cart'></span> Go back";
            echo "</a>";
 	echo "</div>";
 }
